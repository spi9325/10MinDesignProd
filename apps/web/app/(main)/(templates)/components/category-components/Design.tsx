...
interface propType {
  setCurrentDesign: Dispatch<
    SetStateAction<{ opening: string; image: string }>
  >;
  currentDesign: { opening: string; image: string };
}
export function Design({ setCurrentDesign, currentDesign }: propType) {
  return (
    <div className="">
      <div
        onClick={() => setCurrentDesign({ opening: "", image: "" })}
